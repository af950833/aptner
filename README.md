...
25/12/20 1.0.1 관리비 항목이 아파트너 앱에서 지원 안될 경우 모든 센서가 생성 안되는 문제(방문차량 예약 현황은 생성), 동작(서비스) 예약 현황 조회에서 오늘 날짜 예약도 포함

26/02/06 1.0.2 HA 2026.2.0 대응(차량 Entity ID 생성 중 한글 문제 해결)

26/05/16 1.0.3 friendly_name 에 중복 표시 문제 해결
